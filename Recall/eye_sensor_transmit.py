...
def eye_sensor_transmit (t,red_sensor,blue_sensor,green_sensor,black_sensor,brown_left_sensor,brown_right_sensor,brown_left,brown_right,red,blue,black,green):
    ...
    green_sensor.rate = gaussian(green.value, 0.05, 0.012)*35
