...
def follow_place_cell_8 (t,Place_8,brown_left_output,brown_right_output,var_angle):
    ...
    if Place_8.spiked:
            if(var_angle.value <= 270 and var_angle.value > 240):
                return geometry_msgs.msg.Twist(linear=geometry_msgs.msg.Vector3(1,0,0))
            elif(var_angle.value <= 240 and var_angle.value > 90):
                return geometry_msgs.msg.Twist(angular=geometry_msgs.msg.Vector3(0,0,1))
            elif(var_angle.value <= 90 and var_angle.value > 0):
                return geometry_msgs.msg.Twist(angular=geometry_msgs.msg.Vector3(0,0,-1))
            elif(var_angle.value > 270 and var_angle.value <= 360):
                return geometry_msgs.msg.Twist(angular=geometry_msgs.msg.Vector3(0,0,-1))